...
Revision ID: fdaa5b5df487
Revises: 
Create Date: 2025-01-07 03:40:28.298571
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('DRAFT', 'PENDING', 'ACTIVE', 'FUNDED', 'COMPLETED', 'CANCELLED', name='projectstatus'), nullable=True),
